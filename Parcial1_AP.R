...
tab1 = table(dc$Cancellation, dc$Weekday)
as.matrix(tab1) %>% rstatix::cramer_v()

tab2 = table(dc$Cancellation, dc$Country)
as.matrix(tab2) %>% rstatix::cramer_v()

tab3 = table(dc$Weekday, dc$Country)
as.matrix(tab3) %>% rstatix::cramer_v()
